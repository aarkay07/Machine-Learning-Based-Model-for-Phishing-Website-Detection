...
app = Flask(__name__)
model = joblib.load(open('RD.pkl', 'rb'))
...
def predict():
    ...
    if (request.method == "POST"):
        ...
        print(prediction)
        if(prediction == -1):
            return render_template('index.html', prediction_text='Enjoy! This Website is legitimate')
        if(prediction == 1):
            return render_template('index.html', prediction_text='This is Phishing Website! STAY SAFE!')
